 ...
 */
public class NeuralNetworkFitnessFunction implements FitnessFunction{
   ...
   // MathEvaluator math;
    ...
    boolean regression;//
    double penalty;
    public NeuralNetworkFitnessFunction(){
...
//       return 2*(dataSet_train.size()/weightsOfNeuron+1);
   ...
   public int getClassCount(){
    ...
    public void getFitness(Individual i) {
        ...
        regression=true;
        penalty = 0.0;
        i.getFitness().setDouble(get_fitness((NeuronsGEIndividual)i,phenotype, dataSet_train)+penalty * ((NeuronsGEIndividual)i).get_neurons_count() );
            ...
            for (Instance instance : data) {
               ...
               // temp=0.25;
                if (!regression) {
                    ...
                    //temp -= data.classIndex(instance.classValue());
                    temp -= class_label;
                    if (Math.abs(temp) < 0.5 || temp == 0.5 ||class_label==1) {
                        temp = 0;
                    } else {
                        temp = 1;
                    }
