...
public class StatCatcher {
    ...
    protected ArrayList<Double> worstFitness;
    int n;
	...
	this.bestIndividualOfGeneration = new ArrayList<Individual>();
        worstFitness=new ArrayList<Double>();
        }
	...
	this.bestIndividualOfGeneration = new ArrayList<Individual>(gen);
        worstFitness=new ArrayList<Double>(gen);
    }
    ...
    public double getCurrentWorst(){
        return worstFitness.get(worstFitness.size()-1);
    }
