...
public final class Constants {
    ...
    public static final String INIT_RANKING_CLUSTERS="initial_rank_clusters";
    public static final String END_RANKING_CLUSTERS="end_rank_clusters";
    public static final String PENALTY_COEFFICIENT="penalty";

    public static final String SELECTION_PREASURE="selection_preasure";
    public static final String SUS_SELECTION_PREASURE="sus_selection_preasure";
    public static final String WEIGHTS_MUTATION="weights_mutation";

    public static final String REAL_CROSSOVER_ALPHA="real_crossover_alpha";

    public static final String DEVIATION="mutation_deviation";

    public static final String MAX_NEURONS="max_number_of_neurons";

    public static final String NUM_NEURONS="neurons_count";

    public static final String MAX_VALIDATION_EXCEED="max_no_of_validation_exceeds";

    public static final String NUM_INPUTS = "number_of_inputs";
    ...
    public static String Num_Threads="num_threads";
